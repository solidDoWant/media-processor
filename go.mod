...
// Must be pinned until https://github.com/cockroachdb/errors/pull/159 is released due to a compilation bug
require github.com/getsentry/sentry-go v0.45.1 // indirect
