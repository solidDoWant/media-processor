...
| `HEALTH_ADDR` | string (TCP address) | `""` | Optional | TCP address for the HTTP health server (e.g. `:8080`). Exposes `/healthz` (liveness) and `/readyz` (readiness). Disabled when empty. |
